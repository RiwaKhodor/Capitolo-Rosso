      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 px-4 md:px-0">
            <div className={`hidden md:block w-32 h-0.5 bg-gradient-to-r from-transparent via-[#D4AF37] to-[#C7A454] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`} style={{ transitionDelay: '200ms' }}></div>
            ...
            <div className={`hidden md:block w-32 h-0.5 bg-gradient-to-l from-transparent via-[#D4AF37] to-[#C7A454] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'}`} style={{ transitionDelay: '200ms' }}></div>
          </div>
        </div>
