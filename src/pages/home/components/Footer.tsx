          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-start justify-center md:justify-start">
                <i className="ri-phone-line text-[#C7A454] mt-1 mr-3 flex-shrink-0"></i>
                <a href="tel:+493044058471" className="text-sm hover:text-[#C7A454] transition-colors">+49 (0)30 44058471</a>
              </li>
              <li className="flex items-start justify-center md:justify-start">
                <i className="ri-mail-line text-[#C7A454] mt-1 mr-3 flex-shrink-0"></i>
                <a href="mailto:Info@capitolo-rosso.de" className="text-sm hover:text-[#C7A454] transition-colors">Info@capitolo-rosso.de</a>
              </li>
              <li className="flex items-start justify-center md:justify-start">
                <i className="ri-map-pin-line text-[#C7A454] mt-1 mr-3 flex-shrink-0"></i>
                <span className="text-sm text-left">Choriner Straße 72<br />Ecke Zionskirchstraße<br />10119 Berlin<br />Germany</span>
              </li>
            </ul>
